    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          <Link to="/" className="text-2xl font-bold tracking-tighter text-blue-950">
            WEBZIFY<span className="text-blue-600">.</span>
          </Link>
              ...
              link.subLinks ? (
                <div key={link.name} className="relative group">
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      cn(
                        'inline-flex items-center gap-1 text-sm font-medium transition-colors hover:text-blue-600 py-2',
          ...
          <div className="hidden md:block">
            <Link
              to="/contact"
              className="inline-flex h-10 items-center justify-center rounded-md bg-blue-600 px-6 text-sm font-medium text-white transition-colors hover:bg-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-600"
            >
              Get a Free Quote
            </Link>
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-blue-50 border-t shadow-lg py-4 px-4 flex flex-col gap-4 max-h-[80vh] overflow-y-auto">
            ...
            link.subLinks ? (
              <div key={link.name} className="flex flex-col">
                <NavLink
                  ...
                  className={({ isActive }) =>
                    cn(
                      'text-base font-medium transition-colors hover:text-blue-600 block py-2',
                      isActive ? 'text-blue-600' : 'text-gray-600'
                    )
                  }
                >
          ...
          <Link
            to="/contact"
            className="inline-flex h-12 mt-2 w-full items-center justify-center rounded-md bg-blue-600 px-6 text-sm font-medium text-white transition-colors hover:bg-blue-700"
          >
            Get a Free Quote
          </Link>
        </div>
