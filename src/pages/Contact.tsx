              ...
              {formState === 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button 
                    ...
                    className="w-full h-14 rounded-lg bg-primary-600 text-white font-semibold flex items-center justify-center transition-all hover:bg-primary-700 focus:ring-4 focus:ring-primary-500/30 disabled:opacity-70"
                  >
