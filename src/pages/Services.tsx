    ...
    <>
      ...
      <section className="bg-navy-900 text-white pt-20 pb-24 md:pt-28 md:pb-32 overflow-hidden relative">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full bg-primary-600/10 blur-[100px]" />
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className={`${index % 2 !== 0 ? 'lg:col-start-1 lg:row-start-1 lg:ltr' : ''}`}>
                  <h2 className="text-3xl font-bold text-navy-900 mb-6">{service.title}</h2>
                  <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                    {service.description}
                  </p>
                  
                  <div className="mb-8">
                    <h3 className="text-lg font-bold text-navy-900 mb-4">Key Benefits</h3>
                  ...
                  <Link
                    ...
                    className="inline-flex h-12 items-center justify-center rounded-lg bg-navy-900 px-8 text-sm font-semibold text-white transition-all hover:bg-primary-600 group"
                  >
